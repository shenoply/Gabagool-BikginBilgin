...
P=Path(__file__).resolve().parents[2]/'generated'/'junkyard-build32';P.mkdir(parents=True,exist_ok=True);random.seed(22);bpy.ops.object.select_all(action='SELECT');bpy.ops.object.delete(use_global=False)
